...
gl_df <- data.frame(
  field_id = c("G01", "G02", "G03", "G04"),
  area = c("Meissner", "Meissner", "Werrau", "Hebenshausen"),
...
harverst_df <- data.frame(field_id = c("G01", "G02", "G03", "G03","G04", "G04", "G04"),
                          harvest_no = c("H1", "H1", "H1", "H2", "H1", "H2", "H3"),
                          harvest_date = as.Date(c("2018-07-13", "2018-07-13", "2018-05-28", "2018-09-24", "2018-05-10", "2018-06-06", "2018-08-01")),
                          harvest_date_doy = format(as.Date(c("2018-07-13", "2018-07-13", "2018-05-28", "2018-09-24", "2018-05-10", "2018-06-06", "2018-08-01")), "%j"))
...
kable(harverst_df[,c(2:4)], col.names = c("Harvest No.", "Harvest Date", "Harvest Date (DOY)"),
  ...
  group_rows("G04", 5, 7)
```
# 2. Reading and visualise trait data
...
ggplot(bm_data, aes (x = doy, y = db, fill= harvest)) + 
...
ggplot(cn_data, aes (x = doy, y = n, fill= harvest)) + 
  geom_boxplot(alpha = 0.8) +
  facet_grid(. ~ field_id, 
             labeller = labeller(field_id = c(g1 = "G1", g2 = "G2", g3 = "G3", g4 = "G4"))) +
  theme_bw(base_size = 12, base_family = "Lucida") +
...
ggplot(adf_data, aes (x = doy, y = adf, fill= harvest)) + 
  geom_boxplot(alpha = 0.8) +
  facet_grid(. ~ field_id, 
             labeller = labeller(field_id = c(g1 = "G1", g2 = "G2", g3 = "G3", g4 = "G4"))) +
  theme_bw(base_size = 12, base_family = "Lucida") +

---
title: "Summary of the data - Witzenhausen"
...
bm_list <- list.files(path = "./input_wiz/bm/", pattern = "*.csv", full.names = TRUE)
...
```{r speclib_data, echo=FALSE, warning=FALSE, error=FALSE, message = FALSE, fig.align='center', out.width="100%", comment=" ", results="markup"}

...
agdom <- brick("D:/Data_Processing/2018/G1/CUBERT/g1_20180713_cubert/DOM_DEM/g1_20180713_cubert_DOM_100cm.tif")
...
writeRaster(pred_n_svm_raster, 
            filename = "./output/predictRasters/g1_20180713_pred_n.tif", 
            overwrite = TRUE)
...
writeRaster(pred_adf_svm_raster, 
            filename = "./output/predictRasters/g1_20180713_pred_adf.tif", 
            overwrite = TRUE)

## Plotting
par(mfrow=c(1,2))
plot(pred_n_svm_raster, sub = "G1a - H1", main ="N (%DM)",
     font.main=2, font.lab=4, font.sub=4)


plot(pred_adf_svm_raster, sub = "G1a - H1", main = "ADF (%DM)",
     font.main=2, font.lab=4, font.sub=4)
par(mfrow=c(1,1))

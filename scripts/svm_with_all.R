###############################################
# 13.02.2018
# Forage qualitz modelling with SVMR
# JW
###############################################
...
plot(varImp(svm_all_adf), 10, main = "ADF_SVMR")
...
bwplot(svm_all_compare, scales=list(tck=c(1,0), x=list(cex=1.5), y=list(cex=1.5)))
dotplot(svm_all_compare, scales=list(tck=c(1,0), x=list(cex=1.5), y=list(cex=1.5)))
